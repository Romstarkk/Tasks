...
public class lvl6 {
    ...
    public static boolean validColor(String color) {
        ...
        try {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                if (s > 0) {
                    rgb[i] = Integer.parseInt(color.substring(0, s));
                } else {
                    return false;
                }
            ...
            if (format.equals("rgb") && color.length() == 0) {
                return true;
            }
    ...
    public static String[] getHashTags(String title) {
        ...
        for (int i = 0; i < title.length(); i++) {
            ...
            if (c == ' ' || c == ',' || c == '.' || title.length() - 1 == i) {
                ...
                if (word.length() > words[mini].length()) {
                    words[mini] = word;
                }
                s = e + 1;
            }
    ...
    public static int ulam(int n) {
        ...
        for (int x = 4; x < ulams.length; x++) {
            ...
            if (k != 1) {
                for (int y = x; y < ulams.length - 1; y++) {
                    ulams[y] = ulams[y + 1];
                }
    ...
    public static String repchar(char c, int k) {
        String str = "";
        for (int i = 0; i < k; i++) {
            str += c;
        }
    ...
    public static boolean palindromedescendant(String str) {
        if (isPalindrome(str)) {
            ...
            for (int i = 0; i < len; i += 2) {
                tmp += (str.charAt(i) - 48 + str.charAt(i + 1) - 48);
            }
